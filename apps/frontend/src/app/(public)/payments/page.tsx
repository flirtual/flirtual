			...
			<ModelCard className="w-full sm:max-w-2xl" title="Payment Terms">
				<div className="flex flex-col gap-4">
					<p>
						...
						following the date you purchased any Premium subscription. If you
						subscribed through your Apple ID, refunds are handled by Apple.
						Please visit{" "}
					...
					<div className="flex flex-col gap-2">
						...
						<p>
							To cancel your subscription, log in to your account, click/tap
							your profile icon in the corner, then &quot;Premium&quot;, then
							the &quot;Manage&quot; button.
						</p>
						<p>
						...
						<p>
							...
							immediately terminate your account and assume you no longer want
							the subscription. If the chargeback is overturned, please{" "}
							<InlineLink href={urls.resources.contactDirect}>
								contact us
							</InlineLink>{" "}
					...
					<div className="flex flex-col gap-2">
						...
						<p>
							...
							Premium subscriptions, are non-refundable. Special terms for
							refunds apply in the EU, EEA, UK, Switzerland, Korea, Israel,
						...
						<p>
							...
							within 14 days after your subscription begins. This 14-day period
							starts when the subscription starts.
						</p>
						<p>
						...
						<p>
							...
							Republic of Korea: In accordance with local law, you are entitled
							to a full refund of your subscription and/or unused Virtual Items
						...
						<p>
							...
							(excluding Sundays and holidays). If you pass away before the end
							of your subscription period, your estate is entitled to a refund
							for the portion of the subscription payment applicable to the
							period after your death. If you become disabled and unable to use
							Flirtual before the end of your subscription period, you are
							entitled to a refund for the portion of the subscription payment
							applicable to the period after your disability, by providing the
							company notice in the same manner as requesting a refund as
							described below.
						</p>
						<p>
							In addition to canceling your subscription, you must request a
							refund in order to receive one. If you subscribed through your
							Apple ID, refunds are handled by Apple. Please visit{" "}
							<InlineLink href="https://getsupport.apple.com">
								Apple Support
							</InlineLink>{" "}
							to request a refund, or visit the App Store, click/tap on your
							Apple ID, then &quot;Purchase history&quot;, find the transaction
							for your Flirtual subscription, and click/tap &quot;Report
							Problem&quot; to request a refund. If you subscribed through our
							website or Google Play, please{" "}
							<InlineLink href={urls.resources.contactDirect}>
								contact us
							</InlineLink>{" "}
							to request a refund. Please use your Flirtual account email
							address in your refund request.
						</p>
					</div>
				</div>
			</ModelCard>
