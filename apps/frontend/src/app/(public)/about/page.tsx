			...
			>
				...
				<div className="flex flex-col gap-12 px-8 py-10 desktop:px-16">
					<div className="flex flex-col gap-4">
						<h1 className="text-2xl font-semibold">
							{t("pink_proof_insect_beam")}
						</h1>
						<p>{t("awake_orange_clownfish_feel")}</p>
						<p>{t("heroic_light_mantis_grasp")}</p>
						<p>{t("simple_stout_mongoose_stir")}</p>
						<div className="flex flex-col items-start">
							<p>{t("same_quiet_anteater_drum")}</p>
							<InlineLink href={urls.socials.discord}>
								{t("loud_busy_samuel_twist")}
							</InlineLink>
						</div>
						<p className="italic">
					...
					<div className="flex flex-col gap-4">
						...
						<TeamList>
							{[
								...
								{
									name: "Antithalice",
									role: t("whole_tidy_grizzly_care"),
					...
					<div className="flex flex-col gap-4">
						...
						<div className="grid auto-rows-min grid-cols-2 items-center gap-6">
							...
							<div className="flex flex-col px-4">
								...
								<span>{t("slow_misty_frog_link")}</span>
							</div>
							<div className="flex flex-col px-4 text-right">
								<span className="font-montserrat text-2xl font-bold">
									🏆 2019
								</span>
								<span>{t("yummy_tense_samuel_chop")}</span>
							</div>
							<Image
								alt={t("sad_small_oryx_cheer")}
								className="rounded-md shadow-brand-1"
								height={461}
							...
							/>
							<Image
								alt={t("pretty_actual_panda_heal")}
								className="rounded-md shadow-brand-1"
								height={461}
							...
							<div className="flex flex-col px-4">
								...
								<span>{t("lime_left_panther_believe")}</span>
							</div>
							<div className="flex flex-col px-4 text-right">
								<span className="font-montserrat text-2xl font-bold">
									✌️ 2021
								</span>
								<span>{t("nice_spare_panther_relish")}</span>
							</div>
							<Image
								alt={t("small_bland_platypus_offer")}
								className="rounded-md shadow-brand-1"
								height={461}
							...
							<div className="flex flex-col px-4">
								...
								<span>{t("bright_left_frog_pave")}</span>
							</div>
							<div className="flex flex-col px-4 text-right">
								<span className="font-montserrat text-2xl font-bold">
									✨ 2023
								</span>
								<span>{t("long_less_horse_pull")}</span>
							</div>
							<Image
								alt={t("patchy_yummy_ladybug_blink")}
								className="rounded-md shadow-brand-1"
								height={461}
				...
				<div className="grid grid-cols-3">
					...
					<Tooltip>
						...
						<TooltipContent>{t("empty_mealy_mallard_compose")}</TooltipContent>
					</Tooltip>
					<Tooltip>
						<TooltipTrigger asChild>
							<InlineLink href="https://vrchat.com/home/world/wrld_d4f2cc35-83b9-41e9-9b3a-b861691c8df4">
								<Image
									alt={t("curly_bland_bumblebee_kick")}
									height={230}
					...
					<Tooltip>
						...
						<TooltipContent>{t("teal_kind_deer_burn")}</TooltipContent>
					</Tooltip>
					<Tooltip>
						<TooltipTrigger asChild>
							<InlineLink href="https://www.youtube.com/watch?v=zwguAbPv7zg">
								<Image
									alt={t("quick_male_puffin_stab")}
									height={230}
					...
					<Tooltip>
						...
						<TooltipContent>{t("tense_brief_sheep_greet")}</TooltipContent>
					</Tooltip>
				</div>
			</ModelCard>
		</SoleModelLayout>
