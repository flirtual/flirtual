			...
			<ModelCard className="w-full sm:max-w-2xl" title="Terms of Service">
				<div className="flex flex-col gap-4">
					...
					<div className="flex flex-col gap-2">
						...
						<p>
							Studio Paprika is not responsible for the third-party services of
							Google LLC, Cloudflare, Redis Labs, Amazon Web Services,
							Uploadcare, TalkJS, or Elasticsearch.
						</p>
					</div>
					<div className="flex flex-col gap-2">
						...
						<p>
							...
							do not have the right to receive advance notice of these changes
							to your account.
						</p>
						<p>
							If your account is cancelled for violation of these Terms of Use,
							your data will be kept for 30 days so that we can review
							moderation decisions and reverse them if necessary. Please{" "}
							<InlineLink href={urls.resources.contact}>contact us</InlineLink>{" "}
							if you would like to appeal a moderation decision or have your
							data deleted early.
						</p>
					...
					<div className="flex flex-col gap-2">
						...
						<p>
							The Website runs on a virtualized server hosted in the United
							States by Google LLC. This server is protected by industry
							standard efforts such as firewalls. You can read about
							Google&apos;s security efforts{" "}
							<InlineLink href="https://cloud.google.com/security/infrastructure">
								here
							</InlineLink>
							.
						</p>
						...
						<p>
							You are responsible for keeping your account password safe. You
							are responsible for all activities that occur with your account
							credentials.
						</p>
						<p>
