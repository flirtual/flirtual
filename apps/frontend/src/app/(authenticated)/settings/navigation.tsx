...
export const SettingsNavigation: FC = () => {
	...
	return (
		<div className="flex w-full shrink-0 grow-0 select-none flex-col self-baseline desktop:w-80 desktop:rounded-2xl desktop:bg-brand-gradient desktop:text-white-20 desktop:shadow-brand-1">
