...
export default function PrivacyPage() {
	...
	const titleKey = isOutdated ? "privacy_policy_outdated" : "privacy_policy";
	...
	return (
		...
		>
			...
			<p>
				We use first-party, on-premises data analytics. We may share anonymized
				statistics about Flirtual (for example, the number of users that use a
				particular Social VR app or game). You can opt out of these statistics
				in your
				{" "}
				{privacySettingLink}
				.
			...
			<p>
				...
				may be accessed by third parties in order to deliver transactional,
				marketing, and support messages according to your preferences. You may
				opt out of
				{" "}
			...
			<p>
				We use certain trusted third parties that provide services to Flirtual. We
				may share user personal data with these third parties, but only for the
				purpose of providing their services. For more information and examples,
				see below.
			</p>
			<p>
				<strong>Cloud Hosting Services:</strong>
				{" "}
				to provide reliable and secure
				infrastructure for managing and operating our platform (for example,
				Fly.io and Vercel).
			</p>
			<p>
				<strong>In-App Functionality Services:</strong>
				{" "}
				to facilitate key features
				such as messaging and optimized image hosting within our app (for
				example, TalkJS).
			</p>
			<p>
			...
			<p>
				...
				{" "}
				to allow users to connect their
				accounts with our platform and facilitate social interactions (for
				example, Discord).
			</p>
			<p>
				<strong>Security and Performance Services:</strong>
				{" "}
				to safeguard our
			...
			<p>
				<strong>Insight and Improvement Services:</strong>
				{" "}
				to gather user feedback
				and perform analytics for continual improvement of our platform (for
				example, Canny).
			</p>
			<p>
				...
				transactional and marketing communications to users (for example, Amazon
				Web Services).
			</p>
			<p>
				<strong>Moderation Services:</strong>
				{" "}
				to ensure appropriate conduct within
				the app and maintain community standards (for example, Google Cloud).
			</p>
			<p>
				<strong>IT Services:</strong>
				{" "}
				to assist in various operations of our
				business, such as when a user interacts with our support services, which
				may involve processing users&apos; personal data (for example,
				Freshworks).
			</p>
			<p>
				We review third parties we engage with to ensure they have adequate data
				protection and information security measures in place. We take measures to
				protect and anonymize data shared with third parties, as appropriate given
				the nature of the services provided. We only provide trusted third parties
				with the personal data necessary for the service they are providing.
			</p>
			<p>
