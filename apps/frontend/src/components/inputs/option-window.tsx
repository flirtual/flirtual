...
export function InputOptionWindow(props: InputOptionWindowProps<unknown>) {
	...
	return (
		<div
			{...elementProps}
			className={twMerge(
				"focusable-within flex max-h-[min(28rem,60svh)] w-fit min-w-full overflow-x-hidden overflow-y-scroll rounded-xl bg-white-20 shadow-brand-1 dark:bg-black-60",
