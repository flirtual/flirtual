export const dialogOverlayClassName
	= "fixed inset-0 z-[39] bg-black-80/80 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0";
...
export const dialogContentInnerClassName
	= "grid max-h-[calc(90svh-var(--safe-area-inset-top,0rem)-var(--safe-area-inset-bottom,0rem)-3.5rem)] gap-4 overflow-y-auto rounded-2.5xl bg-white-20 p-6 text-black-80 shadow-brand-inset dark:bg-black-70 dark:text-white-20";
