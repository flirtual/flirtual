	...
	<DialogPortal>
		...
		<ThemedBorder asChild>
			...
			>
				...
				<DialogPrimitive.Close className="absolute right-5 top-5 rounded-sm text-black-80 opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none dark:text-white-20">
					<X className="h-5 w-5" />
