...
function DialogHeader({
	...
	return (
		<div
			className={twMerge(
				"flex flex-col gap-2 rounded-t-3xl bg-brand-gradient px-6 pb-3 pt-2 text-center text-white-20 group-data-[drawer]:bg-none group-data-[drawer]:px-0 group-data-[drawer]:py-2 group-data-[drawer]:text-left group-data-[drawer]:text-inherit desktop:text-left",
				className
			)}
			{...props}
		/>
