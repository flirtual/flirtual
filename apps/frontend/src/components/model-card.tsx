...
export const ModelCard: React.FC<ModelCardProps> = ({
	...
	>
		<div
			{...titleProps}
			className={twMerge(
				"w-full bg-brand-gradient py-7 pt-[max(calc(env(safe-area-inset-top)+0.5rem),1.75rem)] text-center font-montserrat text-3xl font-extrabold text-white-10 shadow-brand-1 sm:w-fit sm:max-w-[calc(100%-1.5rem)] sm:rounded-t-[4rem] sm:px-16 sm:pb-4 sm:text-left md:text-4xl",
