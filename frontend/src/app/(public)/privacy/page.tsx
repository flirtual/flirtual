...
export default function PrivacyPage() {
	const privacySettingLink = <InlineLink href={urls.settings.privacy}>privacy settings</InlineLink>;
		...
		<SoleModelLayout>
			...
			>
				<p>
					...
					profile information (including your sexuality, NSFW tags, country, linked accounts, etc.)
					will be visible or hidden to other users depending on your {privacySettingLink}, which you
					can modify at any time. Your personality traits (which we identify based on your answers
					to our personality questionnaire) will be visible or hidden to other users depending on
				...
				<p>
					...
					but will not be shared with other third-parties.
				</p>
				...
				<p>
					...
					<InlineLink href={urls.settings.changePassword}>change your password</InlineLink>{" "}
					immediately and <InlineLink href={urls.resources.contact}>report the issue</InlineLink>{" "}
					with the word &apos;URGENT&apos; in the subject line. In the message, include your
					username, the last time you accessed the site, and any details that led you to suspect a
					break-in.
				</p>
				...
				<p>
					...
					<InlineLink href={urls.settings.list()}>account settings</InlineLink>, and in your
					messages. You can request all of your data that we have on file by emailing us, and will
