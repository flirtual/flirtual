...
export const ModelCard: React.FC<ModelCardProps> = ({
	...
	<div {...props} className={twMerge("w-full shrink-0 sm:w-full sm:max-w-lg", props.className)}>
		<div
			{...titleProps}
			className={twMerge(
				"w-full bg-brand-gradient py-8 text-center font-montserrat text-3xl font-extrabold text-white-10 shadow-brand-1 sm:w-fit sm:rounded-t-[4rem] sm:px-16 sm:pb-4 sm:text-left md:text-4xl",
