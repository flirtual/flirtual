...
export const HeartIcon: React.FC<GradientIconProps> = ({ gradient = true, ...props }) => {
	const id = useId();
		...
		>
			<defs>
				<linearGradient
					...
					y2="286.35"
				>
					<stop offset="0" style={{ stopColor: "var(--light-theme-1)" }} />
					<stop offset="1" style={{ stopColor: "var(--light-theme-2)" }} />
				</linearGradient>
			</defs>
