...
export const SliderInputInner: React.FC<Omit<React.ComponentProps<"input">, "type">> = (props) => (
	<input
		...
		type="range"
		className={twMerge(
			"pointer-events-none absolute w-full appearance-none bg-transparent focus:outline-none range-thumb:pointer-events-auto range-thumb:rounded-full range-thumb:border-none  range-thumb:shadow-brand-1 focus:range-thumb:ring-2 focus:range-thumb:ring-coral focus:range-thumb:ring-offset-2 focus:range-thumb:ring-offset-white-20",
			props.disabled
